                    ...
                    <div className="container px-6 py-12 mx-auto">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex -mx-2">
                                <a href="#" className="mx-2 text-black transition-colors duration-300 w-[40px]" aria-label="WhatsApp">
                                    <img src={WhatIcon} alt="WhatsApp Icon" className='hover:scale-110 transition-all 0.3s ease-in' />
                                </a>

                                <a href="#" className="mx-2 text-black transition-colors duration-300 w-[40px]" aria-label="GitHub">
                                    <img src={GitIcon} alt="GitHub Icon" className='hover:scale-110 transition-all 0.3s ease-in' />
                                </a>

                                <a href="#" className="mx-2 text-black transition-colors duration-300 w-[40px]" aria-label="LinkedIn">
                                    <img src={LinkedIcon} alt="LinkedIn Icon" className='hover:scale-110 transition-all 0.3s ease-in' />
                                </a>

                                <a href="#" className="mx-2 text-black transition-colors duration-300 w-[40px]" aria-label="Instagram">
                                    <img src={InstaIcon} alt="Instagram Icon" className='hover:scale-110 transition-all 0.3s ease-in' />
                                </a>

                                <a href="https://devdigitals.org/" className="mx-2 text-black transition-colors duration-300 w-[40px]" aria-label="Portfolio">
                                    <img src={WebIcon} alt="Portfolio Icon" className='hover:scale-110 transition-all 0.3s ease-in' />
                                </a>
                            </div>
                        </div>
                    </div>
