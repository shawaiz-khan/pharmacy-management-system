...
export default function Footer() {
    ...
    return (
        <div className="flex flex-col justify-center items-center">
            {/* CTA Section */}
            <div className="py-10 px-8 flex items-center justify-between bg-[#002929] w-[900px] rounded-lg -mb-[80px] z-50">
                ...
                <div className="mt-8 flex lg:flex-shrink-0 lg:mt-0">
                    <div className="inline-flex rounded-md shadow">
                        <a href="#" className="bg-green-600 border border-transparent rounded-md py-4 px-6 inline-flex items-center justify-center text-lg font-medium text-white hover:bg-green-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">Search Medicine</a>
                    </div>
                </div>
            </div>
            {/* Footer Section */}
                ...
                <div className="container px-6 py-12 mx-auto">
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4 pt-16">
                        ...
                        <div>
                            ...
                            <div className="flex flex-col items-start mt-5 space-y-2">
                                ...
                                <a href="#" className="text-black transition-colors duration-300   hover:underline ">Who We Are</a>
                                <a href="#" className="text-black transition-colors duration-300   hover:underline ">Our Philosophy</a>
                            </div>
                        </div>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex -mx-2">
                            <a href="#" className="mx-2 text-black transition-colors duration-300   " aria-label="Reddit">
                                <img src="path_to_reddit_icon" alt="Reddit Icon" />
                            </a>

                            <a href="#" className="mx-2 text-black transition-colors duration-300   " aria-label="Facebook">
                                <img src="path_to_facebook_icon" alt="Facebook Icon" />
                            </a>

                            <a href="#" className="mx-2 text-black transition-colors duration-300   " aria-label="Github">
                                <img src="path_to_github_icon" alt="Github Icon" />
                            </a>
                        </div>
                    </div>
                </div>
